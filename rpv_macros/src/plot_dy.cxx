...
int main(){
    ...
    TString folder_bkg_dy   = "/net/cms2/cms2r0/babymaker/babies/2016_08_10/mc/skim_zisr/";
    TString folder_data_dy  = "/net/cms2/cms2r0/babymaker/babies/2016_11_08/data/skim_zisr/";
    ...
    Samples.push_back(sfeats(s_zjets_dy,   "Z+jets",    rpv::c_qcd,   1, cutandweight("stitch&&pass",extraWeight)));
    Samples.push_back(sfeats(s_ttlep_dy,   "t#bar{t}",  rpv::c_tt,    1, cutandweight("stitch&&pass&&ntruleps>=1", extraWeight)));
    Samples.push_back(sfeats(s_wjets_dy,   "W+jets",    rpv::c_wjets, 1, cutandweight("stitch&&pass&&ntruleps>=1",extraWeight)));
    Samples.push_back(sfeats(s_vv_dy,      "WW/WZ/ZZ",  ra4::c_ttv,   1, cutandweight("stitch&&pass",extraWeight)));
    Samples.push_back(sfeats(s_other_dy,   "Other",     rpv::c_other, 1, cutandweight("stitch&&pass",extraWeight))); 
