...
print "%-10s %-30s %-15s %-15s %-15s" % ("Bin", "Process", "Prefit", "Postfit(S+B)", "Postfit(B-only)")
...
while True:
    ...
    if prefit and norm_p and errors:
        ...
        if errors:
            ...
            print "%-10s %-20s %15.2f %15.2f %15.2f" % (m.group(1), m.group(2), norm_p.getVal(), norm_s.getVal(), norm_b.getVal())
