...
function run_combine(){
  ...
  fitdiag=`echo fitDiagnostics_M${2}.root`
  fitdiag_aft=`echo fitDiagnostics_M${2}_s${1}.root`
  higcomb=`echo  higgsCombine_M${2}.FitDiagnostics.mH120.${1}.root`
...
for mass in {1500,1600,1700,1800,1900,2000,2100,2200}; do
  ./run/rescale_variations.exe mconlySplusB variations/output_nominal_newnt_2016.root 2016 ${mass}
