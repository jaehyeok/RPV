...
if __name__=='__main__' :
	...
	for line in f :
		...
		if line=='\n' and len(list_stats)!=0:
			qcd_stats_rl = list_stats[2] - list_stats[0]
			data_stats_rl = list_stats[4] - list_stats[0]
			qcd_stats_fl = list_stats[3] - list_stats[1]
			data_stats_fl = list_stats[5] - list_stats[1]
			if i%2==0 :
