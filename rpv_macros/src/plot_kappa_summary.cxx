...
void kappa_summary_plot_combine() {
  ...
  hist_kappa2->GetYaxis()->SetRangeUser(0.,2.99);
  hist_kappa1->SetMinimum(0.001);
  hist_kappa2->GetXaxis()->SetLabelSize(0.13);
  hist_kappa2->GetXaxis()->SetLabelOffset(0.008);
  //hist_kappa2->GetXaxis()->SetTitle("N_{jet}");
  //hist_kappa2->GetXaxis()->SetTitleOffset(1.5);
  hist_kappa1->GetYaxis()->SetLabelSize(0.09);
  hist_kappa2->GetYaxis()->SetLabelSize(0.09);
//  hist_kappa1->SetTitleSize(2);
//  hist_kappa2->SetTitle("#kappa_{2}");
//  hist_kappa2->SetTitleSize(0.9);
  ...
  TexCMS->SetLineWidth(2);
  TLatex *TexTitle_kap1 = new TLatex(0.07,0.66,"#kappa_{1}");
  TexTitle_kap1->SetNDC();
  TexTitle_kap1->SetTextSize(0.14);
  TexTitle_kap1->SetTextAngle(90);
  TexTitle_kap1->SetTextFont(42);
  TLatex *TexTitle_kap2 = new TLatex(0.07,0.868,"#kappa_{2}");
  TexTitle_kap2->SetNDC();
  TexTitle_kap2->SetTextSize(0.14);
  TexTitle_kap2->SetTextAngle(90);
  TexTitle_kap2->SetTextFont(42);

  // Tex QCD, ttbar, and wjets
  //TLatex *Tex_QCD = new TLatex(0.215,0.03,"QCD");
  TLatex *Tex_QCD = new TLatex(0.165,0.665,"QCD multijet");
  Tex_QCD->SetNDC();
  Tex_QCD->SetTextFont(42);
  Tex_QCD->SetTextSize(0.11);
  //TLatex *Tex_wjets = new TLatex(0.45,0.03,"W+jets");
  TLatex *Tex_wjets = new TLatex(0.475,0.665,"W+jets");
  Tex_wjets->SetNDC();
  Tex_wjets->SetTextFont(42);
  Tex_wjets->SetTextSize(0.11);
  //TLatex *Tex_ttbar = new TLatex(0.785,0.03,"t#bar{t}");
  TLatex *Tex_ttbar = new TLatex(0.787,0.665,"t#bar{t}");
  Tex_ttbar->SetNDC();
  Tex_ttbar->SetTextFont(42);
  Tex_ttbar->SetTextSize(0.11);
  TLatex *Tex_Njet = new TLatex(0.932,0.09,"N_{jet}");
  Tex_Njet->SetNDC();
  //Tex_Njet->SetTextSize(0.105);
  Tex_Njet->SetTextSize(0.12);
  Tex_Njet->SetTextFont(42);

  // Tex (4-5), (6-7) and (\\geq8)
  TLatex *Tex_45_1 = new TLatex(0.155,0.04,"(4-5)");
  Tex_45_1->SetNDC();
  Tex_45_1->SetTextFont(42);
  Tex_45_1->SetTextSize(0.08);
  TLatex *Tex_67_1 = new TLatex(0.243,0.04,"(6-7)");
  Tex_67_1->SetNDC();
  Tex_67_1->SetTextFont(42);
  Tex_67_1->SetTextSize(0.08);
  TLatex *Tex_8_1 = new TLatex(0.337,0.04,"(\\geq8)");
  Tex_8_1->SetNDC();
  Tex_8_1->SetTextFont(42);
  Tex_8_1->SetTextSize(0.08);
  TLatex *Tex_45_2 = new TLatex(0.418,0.04,"(4-5)");
  Tex_45_2->SetNDC();
  Tex_45_2->SetTextFont(42);
  Tex_45_2->SetTextSize(0.08);
  TLatex *Tex_67_2 = new TLatex(0.506,0.04,"(6-7)");
  Tex_67_2->SetNDC();
  Tex_67_2->SetTextFont(42);
  Tex_67_2->SetTextSize(0.08);
  TLatex *Tex_8_2 = new TLatex(0.600,0.04,"(\\geq8)");
  Tex_8_2->SetNDC();
  Tex_8_2->SetTextFont(42);
  Tex_8_2->SetTextSize(0.08);
  TLatex *Tex_45_3 = new TLatex(0.681,0.04,"(4-5)");
  Tex_45_3->SetNDC();
  Tex_45_3->SetTextFont(42);
  Tex_45_3->SetTextSize(0.08);
  TLatex *Tex_67_3 = new TLatex(0.77,0.04,"(6-7)");
  Tex_67_3->SetNDC();
  Tex_67_3->SetTextFont(42);
  Tex_67_3->SetTextSize(0.08);
  TLatex *Tex_8_3 = new TLatex(0.861,0.04,"(\\geq8)");
  Tex_8_3->SetNDC();
  Tex_8_3->SetTextFont(42);
  Tex_8_3->SetTextSize(0.08);

  TLine *line;
  line = new TLine(0, 1., 8.99, 1.);
  line->SetLineColor(kBlack); line->SetLineWidth(1); line->SetLineStyle(2);

  TCanvas *c = new TCanvas("c","c",2100,1600);
  c->Divide(1,2,0.01,0);
