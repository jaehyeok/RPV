...
cp variations/output_nominal_newnt_2016_mconly.root variations/output_impact_2016_rescale.root
#cp variations/output_nominal_newnt_2017_20178_mconly.root variations/output_impact_2017_20178_rescale.root
#cp variations/output_nominal_newnt_2018_20178_mconly.root variations/output_impact_2018_20178_rescale.root
...
for year in 2016; do
    for mass in {1000..2200..100}; do
        echo ${year} ${mass}
        ./run/make_rpv_datacard_newbins_0lstudy.exe ${mass} mconly output_impact_${year}_rescale.root ${year} off on
    done
done
#for year in 2017; do
#    for mass in {1000..2200..100}; do
#        echo ${year} ${mass}
#        ./run/make_rpv_datacard_newbins_0lstudy.exe ${mass} mconly output_impact_${year}_20178_rescale.root ${year} on on
#    done
#done
#for year in 2018; do
#    for mass in {1000..2200..100}; do
