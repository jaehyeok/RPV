...
int main(){ 
  ...
  if(Contains(hostname, "cms") || Contains(hostname, "compute-"))  
   ...
   //data
   TString folder_dat_16 = "/mnt/data3/babies/210910/2016/JetHTRun_rpvfitnbge0_step3/";
   vector<TString> s_data_2016 = getRPVProcess(folder_dat_16,"data");

   TString folder_dat_17 = "/mnt/data3/babies/210910/2017/JetHTRun_rpvfitnbge0_step3/";
   vector<TString> s_data_2017 = getRPVProcess(folder_dat_17,"data");

   TString folder_dat_18 = "/mnt/data3/babies/210910/2018/JetHTRun_rpvfitnbge0_step3/";//FIXME
   vector<TString> s_data_2018 = getRPVProcess(folder_dat_18,"data");

   //MC
   TString folder_DY_16 = "/mnt/data3/babies/210910/2016/merged_norm_dy0923/";
   vector<TString> s_DY_2016 = getRPVProcess(folder_DY_16,"DY");

   TString folder_DY_17 = "/mnt/data3/babies/210910/2017/merged_norm_dy0923/";
   vector<TString> s_DY_2017 = getRPVProcess(folder_DY_17,"DY");

   TString folder_DY_18 = "/mnt/data3/babies/210910/2018/merged_norm_dy0923/";
   vector<TString> s_DY_2018 = getRPVProcess(folder_DY_18,"DY");

   TString folder_DY_1718 = "/mnt/data3/babies/210910/20178/merged_norm_dy0923/";
   vector<TString> s_DY_20178 = getRPVProcess(folder_DY_1718,"DY");

   TString folder_bkg_16 = "/mnt/data3/babies/210910/2016/merged_norm_JER_0903/";
   ...
   TString folder_bkg_17 = "/mnt/data3/babies/210910/2017/merged_norm_JER_0903/";
   ...
   TString folder_bkg_18 = "/mnt/data3/babies/210910/2018/merged_norm_JER_0903/";
   ...
   TString folder_bkg_1718 = "/mnt/data3/babies/210910/20178/merged_norm_JER_0903/";
   ...
   TString folder_sig_16_1600 = "/mnt/data3/babies/210910/2016/merged_norm_sig_pu/";
   vector<TString> s_rpv_2016_1600 = getRPVProcess(folder_sig_16_1600,"rpv_m1600");
   TString folder_sig_16_1800 = "/mnt/data3/babies/210910/2016/merged_norm_sig_pu/";
   vector<TString> s_rpv_2016_1800 = getRPVProcess(folder_sig_16_1800,"rpv_m1800");
   TString folder_sig_16_2000 = "/mnt/data3/babies/210910/2016/merged_norm_sig_pu/";
   vector<TString> s_rpv_2016_2000 = getRPVProcess(folder_sig_16_2000,"rpv_m2000");

   TString folder_sig_17_1600 = "/mnt/data3/babies/210910/2017/merged_norm_sig_pu/";
   vector<TString> s_rpv_2017_1600 = getRPVProcess(folder_sig_17_1600,"rpv_m1600");
   TString folder_sig_17_1800 = "/mnt/data3/babies/210910/2017/merged_norm_sig_pu/";
   vector<TString> s_rpv_2017_1800 = getRPVProcess(folder_sig_17_1800,"rpv_m1800");
   TString folder_sig_17_2000 = "/mnt/data3/babies/210910/2017/merged_norm_sig_pu/";
   vector<TString> s_rpv_2017_2000 = getRPVProcess(folder_sig_17_2000,"rpv_m2000");

   TString folder_sig_18_1600 = "/mnt/data3/babies/210910/2018/merged_norm_sig_pu/";
   vector<TString> s_rpv_2018_1600 = getRPVProcess(folder_sig_18_1600,"rpv_m1600");
   TString folder_sig_18_1800 = "/mnt/data3/babies/210910/2018/merged_norm_sig_pu/";
   vector<TString> s_rpv_2018_1800 = getRPVProcess(folder_sig_18_1800,"rpv_m1800");
   TString folder_sig_18_2000 = "/mnt/data3/babies/210910/2018/merged_norm_sig_pu/";
 ...
 // Samples.push_back(sfeats(s_data_2016, "2016 data (1 fb^{-1})", kBlue,1,"trig_ht900 && trig_jet450 && pass")); //Samples.back().isData=true; 
  ...
  //20178
  Samples.push_back(sfeats(s_wjets_20178, "2017+18 W+jets", kGreen+2,1,cutandweight("pass*(nleps==1&&njets>=4&&njets<=5)","1."))); Samples.back().mcerr=true;Samples.back().isSig=true;
  Samples.push_back(sfeats(s_DY_20178, "2017+18 DYjets", kGray+2,1,cutandweight("pass*(nleps==2&&njets>=3&&njets<=4)","1.")));
  //2017
  ...
  //20178
  Samples.push_back(sfeats(s_wjets_20178, "2017+18 W+jets", kGreen+2,1,cutandweight("pass*(nleps==1&&njets>=6&&njets<=7)","1."))); Samples.back().mcerr=true;Samples.back().isSig=true;
  Samples.push_back(sfeats(s_DY_20178, "2017+18 DYjets", kGray+2,1,cutandweight("pass*(nleps==2&&njets>=5&&njets<=6)","1.")));
  //2017
  ...
  //20178
  Samples.push_back(sfeats(s_wjets_20178, "2017+18 W+jets", kGreen+2,1,cutandweight("pass*(nleps==1&&njets>=8)","1."))); Samples.back().mcerr=true;Samples.back().isSig=true;
  Samples.push_back(sfeats(s_DY_20178, "2017+18 DYjets", kGray+2,1,cutandweight("pass*(nleps==2&&njets>=7)","1.")));
  //2017
