...
void outputMJConnection(std::ofstream &file, const std::vector<std::string> &bins){
  ...
  for(auto jbin:bins){ // ttbar 
    ...
    if(jbin=="bin0"){
      ...
      tmpLine.Replace(5*(bindex["bin2"]*nprocesses+2),4,"1.00");
      tmpLine.Replace(5*(bindex["bin1"]*nprocesses+2),4,"1.00");
      tmpLine.Replace(5*(bindex["bin0"]*nprocesses+2),4,"1.00");
      tmpLine.Prepend("normtt_bin0_1_2_bin3_4_5  lnN  ");
      file << tmpLine.Data() << endl;
    }
    else if(jbin=="bin11"){
      tmpLine.Replace(5*(bindex["bin17"]*nprocesses+2),4,"2.00");
      tmpLine.Replace(5*(bindex["bin16"]*nprocesses+2),4,"1.00");
      tmpLine.Replace(5*(bindex["bin14"]*nprocesses+2),4,"2.00");
      tmpLine.Replace(5*(bindex["bin11"]*nprocesses+2),4,"1.00");
      ...
      tmpLine.Replace(5*(bindex["bin17"]*nprocesses+2),4,"1.00");
      tmpLine.Replace(5*(bindex["bin14"]*nprocesses+2),4,"1.00");
      ...
      tmpLine.Replace(5*(bindex["bin12"]*nprocesses+2),4,"1.00");
      tmpLine.Replace(5*(bindex["bin10"]*nprocesses+2),4,"1.00");
