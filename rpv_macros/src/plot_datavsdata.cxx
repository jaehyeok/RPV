...
int main(){ 
  ...
  Samples.push_back(sfeats(s_data_2018, "2018 data (1 fb^{-1})", kRed,1,"trig_ht1050 && pass")); Samples.back().isData=true;
  Samples.push_back(sfeats(s_data_2017, "2017 data (1 fb^{-1})", kBlue,1,"trig_ht900 && trig_jet450 && pass")); //Samples.back().isData=true; //
  ...
  Samples.push_back(sfeats(s_all_bg_2018, "2018 All_Bkg", kRed,1,cutandweight("pass",extraWeight))); Samples.back().mcerr=true;Samples.back().isSig=true;
  Samples.push_back(sfeats(s_all_bg_2017, "2017 All_Bkg", kBlue,1,cutandweight("pass",extraWeight)));
  Samples.back().doBand = true;
  vector<int> all_bg;
  all_bg.push_back(10);
  all_bg.push_back(11);
