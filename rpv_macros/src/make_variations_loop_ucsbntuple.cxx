...
#include "utilities_macros_rpv_ucsb.hpp"
...
//  TString folder_dat = "/xrootd_user/jaehyeok/xrootd/ucsb_babies/2017_02_14/data/merged_rpvdata_rpvfit/";
    TString folder_dat = "/xrootd_user/jaehyeok/xrootd/ucsb_babies/2017_02_14/data/merged_rpvdata_st1000/";
...
//  TString folder_sig = "/Users/jaehyeok/Research/cms/UCSB/babies/2017_01_10/mc/T1tbs/";
  ...
  TFile *f = new TFile(Form("variations/output_%s_ucsbnt.root", variations.Data()), "recreate");
...
*/
        ...
        if(procname=="qcd" || procname=="ttbar" || 
           procname=="wjets" || procname=="other" ) 
            nominalweight = nominalweight * tree.stitch() * tree.pass()/tree.w_btag();
       ...
       // else if (procname=="data_obs") nominalweight = tree.pass() * (tree.trig_jet450()||tree.trig_ht900()); // rereco
        else if (procname=="data_obs") nominalweight = tree.pass() * (tree.trig()[12]||tree.trig()[54]||tree.trig()[56]); // prompt reco
