...
void outputMJConnection(std::ofstream &file, const std::vector<std::string> &bins, TString year){
  ...
  void outputShapeSystematics(std::ofstream &file, const std::vector<std::string> shapesysts, const std::vector<std::string> shapesysts_name,const std::vector<std::string> &bins, TString year)
  {
    ...
    for(unsigned int index=0; index<nbins; index++){
	  std::string temp = bins.at(index);
	  int binnumber = atoi(temp.erase(0,3).c_str());
	  if(binnumber<52) file << " 1.01 - - - 1.01 ";//accept systematics to signal and other
	  else file << " - - - - - ";//accept systematics to signal and other
    }
    file << "\n";
    file << "ps_isr" << "       lnN ";
...
void outputMCkappaSystematics(std::ofstream &file, const std::vector<std::string> &bins, const std::string filename, TString year)
  {
    ...
    if(filename.find("lownjets")!=std::string::npos){
	  ...
	  else if(int(index/nprocesses)==bindex[Form("bin%d",37)]&&flag_procind)file << "1.00" << " ";
	  else if(int(index/nprocesses)==bindex[Form("bin%d",40)]&&flag_procind)file << "1.00" << " ";
	  else if(int(index/nprocesses)==bindex[Form("bin%d",43)]&&flag_procind)file << "1.00" << " ";
	  else if(int(index/nprocesses)==bindex[Form("bin%d",46)]&&flag_procind)file << "1.00" << " ";
	  else if(int(index/nprocesses)==bindex[Form("bin%d",49)]&&flag_procind)file << "1.00" << " ";
	  else file << "-    ";
	  flag_procind = false;
	}
	file << "\n";
	  ...
	  else if(int(index/nprocesses)==bindex[Form("bin%d",38)]&&flag_procind)file << "1.00" << " ";
	  else if(int(index/nprocesses)==bindex[Form("bin%d",41)]&&flag_procind)file << "1.00" << " ";
	  else if(int(index/nprocesses)==bindex[Form("bin%d",44)]&&flag_procind)file << "1.00" << " ";
	  else if(int(index/nprocesses)==bindex[Form("bin%d",47)]&&flag_procind)file << "1.00" << " ";
	  else if(int(index/nprocesses)==bindex[Form("bin%d",50)]&&flag_procind)file << "1.00" << " ";
	  else file << "-    ";
	  flag_procind = false;
	}
	file << "\n";
	  ...
	  else if(int(index/nprocesses)==bindex[Form("bin%d",39)]&&flag_procind)file << "1.00" << " ";
	  else if(int(index/nprocesses)==bindex[Form("bin%d",42)]&&flag_procind)file << "1.00" << " ";
	  else if(int(index/nprocesses)==bindex[Form("bin%d",45)]&&flag_procind)file << "1.00" << " ";
	  else if(int(index/nprocesses)==bindex[Form("bin%d",48)]&&flag_procind)file << "1.00" << " ";
	  else if(int(index/nprocesses)==bindex[Form("bin%d",51)]&&flag_procind)file << "1.00" << " ";
	  else file << "-    ";
	  flag_procind = false;
	}
	file << "\n";
	  ...
	  iproc_check = true;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",37)]){ 
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",40)]){ 
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",43)]){ 
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",46)]){ 
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",49)]){ 
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
	  ...
	  iproc_check = true;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",38)]){  
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",41)]){  
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",44)]){  
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",47)]){  
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",50)]){  
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
	  ...
	  iproc_check = true;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",39)]){  
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",42)]){  
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",45)]){  
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",48)]){  
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
	    ...
	    if(iproc_check) file << "-    ";
          ...
          else if(int(index/nprocesses)==bindex[Form("bin%d",51)]){  
            for(auto iproc : process){
      	      if(int(index%5)==procind[iproc]){ 
		file << "1.00" << " ";
		iproc_check = false;
...
//    for(uint iproc=0; iproc<2; iproc++){
	...
	if(iproc=="qcd") continue;    // Regarding MJSyst, QCD is not considered. Only are ttbar and W+jets considered.
        for(int i_kap=1; i_kap<3; i_kap++){
  	    ...
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",37)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",40)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",43)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",46)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",49)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else file << "-    ";
  	  }
  	  file << "\n";
        }
	...
	if(iproc=="qcd") continue;    // Regarding MJSyst, QCD is not considered. Only are ttbar and W+jets considered.
        for(int i_kap=1; i_kap<3; i_kap++){
  	    ...
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",38)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",41)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",44)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",47)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",50)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else file << "-    ";
  	  }
  	  file << "\n";
        }
	...
	if(iproc=="qcd") continue;    // Regarding MJSyst, QCD is not considered. Only are ttbar and W+jets considered.
        for(int i_kap=1; i_kap<3; i_kap++){
  	    ...
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",39)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",42)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",45)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",48)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else if(int(index/nprocesses)==bindex[Form("bin%d",51)]&&int(index%5)==procind[iproc]) file << "1.00" << " ";
  	    else file << "-    ";
  	  }
  	  file << "\n";
        }
