...
#	for syst in {kappa,mur,murf,muf,lep_eff,btag_udsg,btag_bc,isr,jec,jer,gs}; do
...
#	hadd -f variations/output_impact_${year}.root variations/output_nominal_newnt_${year}.root variations/output_syst_${year}.root 
	...
	hadd -f variations/output_impact_${year}.root variations/output_nominal_newnt_${year}.root variations/output_syst_${year}.root variations/output_${year}_mckappa.root
