...
int main()
{
    ...
    TString bin[52] = {
        // control regions
        "0-lepton,HT>1500,4#leq N_{jets}#leq5,520<MJ<800",
        "0-lepton,HT>1500,6#leq N_{jets}#leq7,520<MJ<800",
        "1-lepton,HT>1200,4#leq N_{jets}#leq5,520<MJ<800", 
        ...
        "0-lepton,HT>1500,4#leq N_{jets}#leq5,300<MJ<520",  // 6
        "0-lepton,HT>1500,6#leq N_{jets}#leq7,300<MJ<520",
        "0-lepton,HT>1500,8#leq N_{jets}#leq9,300<MJ<520",
        "0-lepton,HT>1500,N_{jets}#geq10,300<MJ<520",
        // signal regions, low MJ
        "0-lepton,HT>1500,N_{jets}#geq10,520<MJ<800",       // 10
        "1-lepton,HT>1200,6#leq N_{jets}#leq7,520<MJ<800",
        "1-lepton,HT>1200,N_{jets}#geq8,520<MJ<800",
        ...
        // Missing regions
        "0-lepton,HT>1500,8#leq N_{jets}#leq9,520<MJ<800",  // 16
	...
	"0-lepton,HT>1200,N_{jets}#geq8,N_{b}=0",
	"0-lepton,HT>1200,6#leq N_{jets}#leq7,N_{b}=1",
	"0-lepton,HT>1200,8#leq N_{jets}#leq9,N_{b}=1",
	"0-lepton,HT>1200,N_{jets}#geq8,N_{b}=1",
	"0-lepton,HT>1200,6#leq N_{jets}#leq7,N_{b}=2",
	"0-lepton,HT>1200,8#leq N_{jets}#leq9,N_{b}=2",
	"0-lepton,HT>1200,N_{jets}#geq8,N_{b}=2",
	"0-lepton,HT>1200,6#leq N_{jets}#leq7,N_{b}=3",
	"0-lepton,HT>1200,8#leq N_{jets}#leq9,N_{b}=3",
	"0-lepton,HT>1200,N_{jets}#geq8,N_{b}=3",
	"0-lepton,HT>1200,6#leq N_{jets}#leq7,N_{b}#geq4",
	"0-lepton,HT>1200,8#leq N_{jets}#leq9,N_{b}#geq4",
	"0-lepton,HT>1200,N_{jets}#geq8,N_{b}#geq4"
    };

    TString binLatex[52] = {
        // control regions
        "N_{leps}=0,H_{T}>1500~\\textrm{GeV},4\\leq N_{jets}\\leq5, 520<M_{J}<800~\\textrm{GeV}",
        "N_{leps}=0,H_{T}>1500~\\textrm{GeV},6\\leq N_{jets}\\leq7, 520<M_{J}<800~\\textrm{GeV}",
        "N_{leps}=1,H_{T}>1200~\\textrm{GeV},4\\leq N_{jets}\\leq5, 520<M_{J}<800~\\textrm{GeV}", 
        ...
        "N_{leps}=0,H_{T}>1500~\\textrm{GeV},4\\leq N_{jets}\\leq5,300<M_{J}<520~\\textrm{GeV}",  // 6
        "N_{leps}=0,H_{T}>1500~\\textrm{GeV},6\\leq N_{jets}\\leq7,300<M_{J}<520~\\textrm{GeV}",
        "N_{leps}=0,H_{T}>1500~\\textrm{GeV},8\\leq N_{jets}\\leq9,300<M_{J}<520~\\textrm{GeV}",
        "N_{leps}=0,H_{T}>1500~\\textrm{GeV},N_{jets}\\geq10,300<M_{J}<520~\\textrm{GeV}",
        // signal regions, low M_{J}
        "N_{leps}=0,H_{T}>1500~\\textrm{GeV},N_{jets}\\geq10,520<M_{J}<800~\\textrm{GeV}",       // 10
        "N_{leps}=1,H_{T}>1200~\\textrm{GeV},6\\leq N_{jets}\\leq7,520<M_{J}<800~\\textrm{GeV}",
        "N_{leps}=1,H_{T}>1200~\\textrm{GeV},N_{jets}\\geq8,520<M_{J}<800~\\textrm{GeV}",
        ...
        // Missing regions
        "N_{leps}=0,H_{T}>1500~\\textrm{GeV},8\\leq N_{jets}\\leq9,520<M_{J}<800~\\textrm{GeV}",  // 16
