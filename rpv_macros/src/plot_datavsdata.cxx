...
int main(){ 
  ...
  for(auto icut : cuts){
    ...
    //vars.push_back(hfeats("nbm", 2, 0, 2, ttbar, "N_{b}", icut,-1,"ttbar"));
    ...
    //vars.push_back(hfeats("ht", 10, 0, 8000, ttbar, "H_{t}", icut,-1,"ttbar"));// */
    //vars.back().normalize = true;
    //vars.push_back(hfeats("nbm", 2, 0, 2, qcd, "N_{b}", icut,-1,"qcd"));
    //vars.push_back(hfeats("njets", 21, 0, 21, qcd, "NJets", icut,-1,"qcd"));
    //vars.push_back(hfeats("mj12", 3, 500, 1400, qcd, "mj12", icut,-1,"qcd"));
    //vars.push_back(hfeats("ht", 10, 0, 8000, qcd, "H_{t}", icut,-1,"qcd"));// */
    /*vars.back().normalize = true;
    //vars.push_back(hfeats("nbm", 2, 0, 2, other, "N_{b}", icut,-1,"other"));
    ...
    //vars.push_back(hfeats("ht", 10, 0, 8000, other, "H_{t}", icut,-1,"other"));// */
    /*vars.back().normalize = true;
    //vars.push_back(hfeats("nbm", 2, 0, 2, wjets, "N_{b}", icut,-1,"wjets"));
    ...
    //vars.push_back(hfeats("ht", 10, 0, 8000, wjets, "H_{t}", icut,-1,"wjets"));// */
    //vars.back().normalize = true;
  }
