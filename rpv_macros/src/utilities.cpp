...
vector<TString> folder_year(TString year, bool te){
  ...
  /*  ret.push_back("/data2/babies/20210430/"+year+"/merged_norm_noMJ/");
    ret.push_back("/data2/babies/20210430/"+year+"/merged_norm_noMJ/");
    ret.push_back("/data2/babies/20210430/"+year+"/merged_norm_noMJ/");
    ret.push_back("/data2/babies/20210430/"+year+"/merged_norm_noMJ/");
*/
/*    ret.push_back("/data2/babies/20210430/"+year+"/merged_norm/");
    ret.push_back("/data2/babies/20210430/"+year+"/skim_rpvfitnbge0_nbm2/");
    ret.push_back("/data2/babies/20210430/"+year+"/merged_norm/");
    ret.push_back("/data2/babies/20210217/"+year+"/skim_rpvfitnbge0_njets3nleps2/");

    ret.push_back("/xrootd_user/yjeong/xrootd/nanoprocessing/"+year+"/merged_norm/");
    ret.push_back("/xrootd_user/yjeong/xrootd/nanoprocessing/"+year+"/skim_rpvfitnbge0_nbm2/");
    ret.push_back("/xrootd_user/yjeong/xrootd/nanoprocessing/"+year+"/merged_norm_sig_210501/");
